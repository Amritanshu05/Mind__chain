  ...
  const teamMembers = [
    {
      ...
      github: 'https://github.com/Amritanshu05',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20'>
        <div className='text-center mb-8'>
          <h1 className='text-4xl font-bold tracking-tight mb-4'>
            About <span className='text-[#f58b44]'>Soul_chain</span>
          </h1>
          <p className='max-w-2xl mx-auto text-lg'>
            Soul_chain combines blockchain with mental wellness to create a rewarding mindfulness experience.
          ***REMOVED***
        ***REMOVED***
        <div className='py-2'>
                ...
                <div className='h-28 bg-[#f58b44] flex items-center px-5'>
                  ...
                  ***REMOVED***
                  <div>
                    ...
                    <p className='text-[#fdf5eb] font-medium'>{member.role}***REMOVED***
                  ***REMOVED***
                ***REMOVED***
                <div className='p-5'>
                  <p className='mb-4'>{member.description}***REMOVED***
