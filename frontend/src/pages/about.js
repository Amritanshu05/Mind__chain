  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20'>
        {/* About Soul_chain Section */}
        <div className='text-center mb-8'>
          <h1 className='text-4xl font-bold tracking-tight text-gray-900 dark:text-white mb-4'>
            About{' '}
            <span className='text-blue-600 dark:text-blue-400'>Soul_chain</span>
          </h1>
          <p className='max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300'>
            Soul_chain combines blockchain with mental wellness to create a
                ...
                <div className='h-28 bg-gradient-to-r from-blue-500 to-purple-600 flex items-center px-5'>
                  ...
                  ***REMOVED***
                  <div>
                    ...
                    <p className='text-blue-100 font-medium'>{member.role}***REMOVED***
                  ***REMOVED***
                ***REMOVED***
