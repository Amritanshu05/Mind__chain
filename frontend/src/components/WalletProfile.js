      ...
      {walletAddress ? (
        <div className='relative wallet-dropdown'>
          ...
          <div className='relative'>
            ...
            />
            <div className='absolute -top-1 -right-1 w-3 h-3 bg-green-500 rounded-full border-2 border-white dark:border-gray-800'>***REMOVED***
          ***REMOVED***
                ...
                <div className='mb-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-800 p-3 rounded-lg'>
                  <div className='flex items-center justify-between mb-2'>
                    <div className='flex items-center'>
                      <div className='w-2 h-2 bg-blue-500 rounded-full mr-2'>***REMOVED***
