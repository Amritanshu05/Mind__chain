      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-xl text-gray-600 dark:text-gray-400">
            Share your knowledge with the Soul_chain community
          ***REMOVED***
        ***REMOVED***
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                />
                {errors.title && (
                  <p className="mt-1 text-sm text-red-500">{errors.title}***REMOVED***
                )}
              ***REMOVED***
              ...
              <div className="mb-6">
                ...
                ***REMOVED***
                {errors.price && (
                  <p className="mt-1 text-sm text-red-500">{errors.price}***REMOVED***
                )}
              ***REMOVED***
              ...
              <div className="mb-6">
                ...
                />
                {errors.description && (
                  <p className="mt-1 text-sm text-red-500">{errors.description}***REMOVED***
                )}
                  ...
                  {!previewImage ? (
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <p className="pl-1">or drag and drop***REMOVED***
                      ***REMOVED***
