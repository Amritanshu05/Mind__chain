                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 gap-y-16'>
                        <div className='col-span-1 flex flex-col'>
                            ...
                            <a className='flex items-center opacity-50 hover:opacity-100 transition-opacity duration-1000 ease-out' href="#">
                                <p className='text-gray-700 dark:text-gray-300 text-lg font-semibold py-1 underline '>  {t('MeditationForX.Lists.1.SeeMore')}  ***REMOVED*** 
                        ...
                        ***REMOVED***
                        ...
                        <div className='col-span-1 flex flex-col'>
                            ...
                            <a className='flex items-center opacity-50 hover:opacity-100 transition-opacity duration-1000 ease-out' href="https://www.headspace.com/meditation">
                                <p className='text-gray-700 dark:text-gray-300 text-lg font-semibold py-1 underline '> {t('MeditationForX.Lists.2.SeeMore')} ***REMOVED*** 
                                <FiArrowRight className='text-gray-600 dark:text-gray-300' /> 
                            </a>
                        ***REMOVED***
                        ...
                        <div className='col-span-1 flex flex-col'>
                            ...
                            <a className='flex items-center opacity-50 hover:opacity-100 transition-opacity duration-1000 ease-out' href="https://www.headspace.com/meditation">
                                <p className='text-gray-700 dark:text-gray-300 text-lg font-semibold py-1 underline '> {t('MeditationForX.Lists.3.SeeMore')} ***REMOVED*** 
                                <FiArrowRight className='text-gray-600 dark:text-gray-300' /> 
                            </a>
                        ***REMOVED***
                        ...
                        <div className='col-span-1 flex flex-col'>
                            ...
                            <a className='flex items-center opacity-50 hover:opacity-100 transition-opacity duration-1000 ease-out' href="#">
                                <p className='text-gray-700 dark:text-gray-300 text-lg font-semibold py-1 underline '> {t('MeditationForX.Lists.4.SeeMore')} ***REMOVED*** 
                                <FiArrowRight className='text-gray-600 dark:text-gray-300' /> 
                            </a>
                        ***REMOVED***
