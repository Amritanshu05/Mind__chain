      ...
      {walletAddress ? (
        <div className='relative wallet-dropdown'>
          ...
          <div className='relative'>
            ...
            />
            <div className='absolute -top-1 -right-1 w-3 h-3 bg-green-500 rounded-full border-2 border-[#fdf5eb] dark:border-[#4b5161]'>***REMOVED***
          ***REMOVED***
                ...
                <div className='mb-4 bg-[#fdf5eb] dark:bg-[#4b5161] p-3 rounded-lg'>
                  <div className='flex items-center justify-between mb-2'>
                    <div className='flex items-center'>
                      <div className='w-2 h-2 bg-[#f58b44] rounded-full mr-2'>***REMOVED***
                      <p className='text-md font-medium text-[#4b5161] dark:text-[#fdf5eb]'>
                        SOUL Tokens
                      ***REMOVED***
                    ***REMOVED***
                    <div className='flex items-center gap-2'>
                      <p className='font-bold text-[#f58b44]'>{balance}***REMOVED***
                      <button
                  ...
                  ***REMOVED***
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center'>
                      <div className='w-2 h-2 bg-green-500 rounded-full mr-2'>***REMOVED***
                      <p className='text-md font-medium text-[#4b5161] dark:text-[#fdf5eb]'>
                        PYUSD Tokens
                      ***REMOVED***
                    ***REMOVED***
