            ...
            ***REMOVED***
            ...
            {loading ? (
                <div className='flex justify-center items-center flex-grow'>
                    <p className='text-lg font-medium'>Loading...***REMOVED***
                ***REMOVED***
            ) : (
                    ...
                    <div className='px-10 mb-10'>
                        ...
                        {purchasedWorkshops.length > 0 ? (
                            ...
                            ***REMOVED***
                            ...
                            <p className='text-lg font-medium'>You have not purchased any workshops yet.***REMOVED***
                        )}
                    ***REMOVED***
                    ...
                    <div className='px-10'>
                        ...
                        {createdWorkshops.length > 0 ? (
                            ...
                            ***REMOVED***
                            ...
                            <p className='text-lg font-medium'>You have not created any workshops yet.***REMOVED***
                        )}
                    ***REMOVED***
                ***REMOVED***
            )}
            ...
            <footer className='bg-[#4b5161] text-[#fdf5eb] py-4 text-center mt-auto'>
                © 2025 Soul_chain. All rights reserved.
            </footer>
        ***REMOVED***
    )
}
